...
<html lang="en">
	<head>
		...
		<title>Login · <?= $this->Company_model->first()->name ?></title>
	...
	<body>
		<form class="form-signin" method="post" action="<?= site_url('login') ?>">
			...
			<div class="text-center mb-4">
				...
				<p>
					Silahkan login agar dapat order sepuasnya ya. <br />
					Kami selalu siap untuk melayani anda. <br />
				</p>
			</div>
			...
			<a href="<?= site_url('register') ?>">Belum punya akun ?</a>
